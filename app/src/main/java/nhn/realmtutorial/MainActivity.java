...
import nhn.realmtutorial.adapter.BooksAdapter;
import nhn.realmtutorial.adapter.RealmBookAdapter;
...
//        }
    ...
    public void setRealmAdapter(RealmResults<Book> books) {
        ...
        RealmBookAdapter realmAdapter = new RealmBookAdapter(this.getApplicationContext(), books, true);
